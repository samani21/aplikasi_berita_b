...
import 'package:aplikasi_berita_b/common/string_extensions.dart';
import 'package:aplikasi_berita_b/common/theme.dart';
import 'package:aplikasi_berita_b/presentation/bloc/article_category_bloc/article_category_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0.0,
          title: Text(widget.category.topCapitalized(),
